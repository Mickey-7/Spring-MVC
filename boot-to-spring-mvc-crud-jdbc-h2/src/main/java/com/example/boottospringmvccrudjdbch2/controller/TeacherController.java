package com.example.boottospringmvccrudjdbch2.controller;

import com.example.boottospringmvccrudjdbch2.model.Teacher;
import com.example.boottospringmvccrudjdbch2.service.TeacherService;
...
//while @RestController simply return object and object data directly written into http response as JSON orXML.
public class TeacherController {
    ...
    public String addTeacher(@RequestParam(value = "id", required = true) int id,
                             @RequestParam(value = "name", required = true) String name,
                             @RequestParam(value = "expertise", required = true) String expertise,
                             ModelMap teacherModel) {
